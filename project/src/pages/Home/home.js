...
function Home() {
  return (
    <div className="body">
      ...
      <div className="text">
        <p>
          O presente projeto possui por objetivo realizar um sistema completo
          utilizando reactJs, react hooks, redux e redux saga. O sistema
          fornecerá dicas de como economizar, organizar suas finanças e fazer
          renda extra, com base nas respostas que o usuário fornecer. O projeto
          ainda não possui um nome oficial, por isso, estaremos chamando apenas
          de "Project".
        </p>
        <p>
